# Using Python to Interact with the Operating System - Week 6 - Bash Scripting

## Interacting with the Command Line Shell
### Basic Linux Commands
* A lot of commands come from Unix. 
* The philosophy when designing how these programs should behave was that they should do one thing and do it very well, Which means there will be a lot of commands, each for doing specific thing.
